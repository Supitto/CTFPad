...
(function() {
  $(function() {
    var proto, sessid, sock, updateProgress;
    ...
    $('body').delegate('.delete-challenge', 'click', function() {
      var a;
      a = $(this).parent();
      if (a.find('input[name="delete"]')[0].value === "new") {
        ...
        return a.find('input[name="delete"]').val('true');
      } else {
        a.removeClass('highlighted');
        return a.find('input[name="delete"]').val('false');
      }
    });
